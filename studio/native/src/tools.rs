...
pub use studio_core::ShortcutKey as Key;
...
pub fn resolve_shortcut(
    ...
    resolve_shortcut_with_bindings(
        ...
        pressed,
        input_blocked,
        &studio_core::ShortcutBindings::default(),
    )
}
...
pub fn resolve_shortcut_with_bindings(
    ...
    pressed: bool,
    input_blocked: bool,
    bindings: &studio_core::ShortcutBindings,
) -> Option<Shortcut> {
...
fn shortcut_for_action(action: studio_core::ShortcutAction) -> Shortcut {
    use studio_core::ShortcutAction as A;
    match action {
...
pub enum Drag {
    ...
    Resize {
        handle: studio_core::Handle,
        start_box: studio_core::BBox,
        orig: Vec<(usize, studio_core::Shape)>,
        target_box: studio_core::BBox,
        gpu_live: bool,
    },
...
mod shortcut_tests {
    ...
    fn benutzerdefinierte_belegung_ersetzt_den_standard_lookup() {
        let mut bindings = studio_core::ShortcutBindings::default();
        let custom = studio_core::ShortcutTrigger::Key(studio_core::ShortcutChord::key(Key::Q));
        bindings
            .reassign(studio_core::ShortcutAction::ToolRect, custom)
            .unwrap();
